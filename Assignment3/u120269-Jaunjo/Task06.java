...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		Individual researcher_jane = model.createIndividual(ns + "Jane Smith", researcher);	
		
		// ** TASK 6.5: Add to the individual JaneSmith the fullName, given and family names **
		researcher_jane.addLiteral(VCARD.FN, "Jane Smith");
		researcher_jane.addLiteral(VCARD.Given, "Jane");
		researcher_jane.addLiteral(VCARD.Family, "Smith");
